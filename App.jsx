  ...
  return (
    <Phone>
      <div className="stack hero">
        ...
        <p className="lead">
          Simulate three holes and get a practical Next Round Plan.
        </p>

        <Card>
          <p className="eyebrow">Prototype test</p>
          <p>
            Use realistic outcomes from your last few rounds. This is testing whether
            the advice feels useful enough to try next time you play.
          </p>
        </Card>
    ...
    <Phone>
      <div className="stack">
        <div>
          ...
          <h2>What happened?</h2>
          <p className="muted">
            Keep it simple. Tap the things that applied to this hole.
          </p>
        </div>
    ...
    <Phone>
      <div className="stack">
        <div>
          ...
          <p className="muted">
            The prototype uses a simple rule engine to identify your top two leaks.
          </p>
        </div>
    ...
    <Phone>
      <div className="stack">
        <div>
          ...
          <p className="muted">
            The goal is to give you something simple enough to remember on the course.
          </p>
        </div>
    ...
    <Phone>
      <div className="stack hero">
        ...
        <Card>
          ...
          <p>
            Would you trust this enough to follow it in your next real round?
          </p>
        </Card>
...
function App() {
  ...
  if (screen === "summary") {
    return <Summary leaks={leaks} createPlan={() => setScreen("plan")} restart={reset} />;
  }

  if (screen === "plan") {
    return <Plan tips={tips} nextPrompt={() => setScreen("prompt")} restart={reset} />;
  }

  if (screen === "prompt") {
    return <Prompt tips={tips} restart={reset} />;
  }
